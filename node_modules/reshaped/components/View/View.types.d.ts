...
export type Props<TagName extends keyof JSX.IntrinsicElements = "div"> = {
    ...
    borderColor?: "neutral" | "neutral-faded" | "critical" | "critical-faded" | "warning" | "warning-faded" | "positive" | "positive-faded" | "primary" | "primary-faded" | "disabled" | "brand" | "transparent";
