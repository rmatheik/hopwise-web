...
export const variants = () => (<Example>
		<Example.Item title="variant: faded">
			<Select variant="faded" name="animal" placeholder="Select an animal" value="dog" options={[
        { label: "Dog", value: "dog" },
        { label: "Turtle", value: "turtle" },
		...
		<Example.Item title="variant: headless">
			<Select variant="headless" name="animal" placeholder="Select an animal" value="dog" options={[
        { label: "Dog", value: "dog" },
        { label: "Turtle", value: "turtle" },
    ]} inputAttributes={{ "aria-label": "test select" }}/>
		</Example.Item>
...
export const size = () => (<Example>
		...
		<Example.Item title={["responsive size", "[s] xlarge", "[m+] medium"]}>
			<Select name="animal" size={{ s: "xlarge", m: "medium" }} options={[
        { label: "Dog", value: "dog" },
        { label: "Turtle", value: "turtle" },
    ]} inputAttributes={{ "aria-label": "test select" }}/>
		</Example.Item>
...
export const disabled = () => (<Example>
		<Example.Item title="disabled">
			<Select disabled name="animal" placeholder="Select an animal" options={[
        { label: "Dog", value: "dog" },
        { label: "Turtle", value: "turtle" },
    ]} inputAttributes={{ "aria-label": "test select" }}/>
		</Example.Item>
...
export const error = () => (<Example>
		<Example.Item title="error">
			<Select name="animal" hasError placeholder="Select an animal" options={[
        { label: "Dog", value: "dog" },
        { label: "Turtle", value: "turtle" },
    ]} inputAttributes={{ "aria-label": "test select" }}/>
		</Example.Item>
...
export const icon = () => (<Example>
		<Example.Item title="icon">
			<Select name="animal" placeholder="Select an animal" options={[
        { label: "Dog", value: "dog" },
        { label: "Turtle", value: "turtle" },
    ]} icon={IconZap} inputAttributes={{ "aria-label": "test select" }}/>
		</Example.Item>
	</Example>);
export const slots = () => (<Example>
        ...
        { label: "Dog", value: "dog" },
        { label: "Turtle", value: "turtle" },
    ]} startSlot={<View height="20px" width="20px" backgroundColor="neutral" borderRadius="small"/>} inputAttributes={{ "aria-label": "test select" }}/>
		</Example.Item>
	</Example>);
export const triggerComposition = () => (<Example>
		<Example.Item title="select with dropdown menu">
			<DropdownMenu width="trigger">
				<DropdownMenu.Trigger>
					{(attributes) => (<Select name="animal" placeholder="Select an animal" startSlot={<View height="20px" width="20px" backgroundColor="neutral" borderRadius="small"/>} inputAttributes={attributes}>
							Hello
						</Select>)}
				</DropdownMenu.Trigger>
