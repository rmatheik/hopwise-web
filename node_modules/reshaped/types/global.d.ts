...
export type Attributes<TagName = void, O = void> = Omit<(TagName extends keyof JSX.IntrinsicElements ? JSX.IntrinsicElements[TagName] : React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>) & DataAttributes & {
...
export type ChangeHandler<Value, Event = React.ChangeEvent<HTMLInputElement>> = (args: ChangeHandlerArgs<Value, Event>) => void;
export {};
