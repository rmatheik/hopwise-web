...
type KeyValuePair<TKey extends keyof any = string, TValue = string> = Record<TKey, TValue>;
type ConfigUtils = {
...
type ExperimentalConfig = 'all' | Record<any, never> | [];
type DarkModeConfig = false | 'media' | 'class';
type ThemeConfig = Partial<{
    extend: Partial<Omit<ThemeConfig, 'extend'>>;
    /** Responsiveness */
    screens: ResolvableTo<KeyValuePair>;
    /** Reusable base configs */
    colors: ResolvableTo<KeyValuePair | Record<string, Record<string | number, string> | string>>;
    ...
    /** Border */
    borderColor: ThemeConfig['colors'] | any;
    ...
    /** Components */
    container: Partial<{
        screens: string[] /** List of breakpoints. E.g.: '400px', '500px' */
...
type VariantConfig = string[] | Partial<{
    variants: string[];
    respectPrefix: false;
...
type PluginAPI = {
    ...
    addUtilities: (utilities: Record<string, KeyValuePair | Record<string, KeyValuePair>>, variantConfig?: VariantConfig) => void;
    /** Ability to add components. E.g.: .btn */
    addComponents: (components: Record<string, KeyValuePair | Record<string, KeyValuePair>>, variantConfig?: VariantConfig) => void;
    addBase: (base: Record<string, KeyValuePair | Record<string, KeyValuePair>>) => void;
...
export type TailwindConfig = Partial<BaseConfig & {
