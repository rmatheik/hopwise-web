...
export declare function getSupabaseServer(bearer?: string): import("@supabase/supabase-js").SupabaseClient<Database, "public", {
    Tables: {
        change_log: {
            Row: {
...
export declare function getPaymentDetailsDB(): import("@supabase/postgrest-js").PostgrestQueryBuilder<{
    Tables: {
        change_log: {
            Row: {
                created_at: string | null;
