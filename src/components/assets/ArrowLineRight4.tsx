import "./ArrowLineRight4.css";

export default function ArrowLineRight4({
  className = "",
}: ArrowLineRight4Props) {
  return (
...
interface ArrowLineRight4Props {
  className?: string;
}
